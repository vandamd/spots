          ...
          <Dialog>
            ...
            >
              ...
              <div className="space-y-3 text-sm text-zinc-400">
                ...
                <p>Made with 💛 by <a href="https://vandamdinh.com" target="_blank" className="text-white">Vandam</a>! You can view the source code <a href="https://github.com/vandamd/spots" className="text-white">here</a>.</p>
                <p>Largely inspired by <a href="https://spots.aksharbarot.com/" className="text-white">Spots</a> by Akshar Barot. I've adapted this site to use the endpoints found <a href="https://www.bris.ac.uk/where-is-my/find/" className="text-white">here</a>.</p>
